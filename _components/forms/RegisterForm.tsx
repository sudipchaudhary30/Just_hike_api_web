      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center">
          ...
          <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
            I agree to the{' '}
            <Link href="/terms" className="text-[#45D1C1] hover:underline">
              Terms & Conditions
            </Link>{' '}
            and{' '}
            <Link href="/privacy" className="text-[#45D1C1] hover:underline">
              Privacy Policy
            </Link>
          </label>
        </div>
        ...
        <div className="text-center text-sm text-gray-600">
          ...
          <Link href="/auth/login" className="text-[#45D1C1] font-semibold hover:underline">
            Login here
          </Link>
        </div>
      </form>
